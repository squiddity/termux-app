...
public final class TermuxConstants {
    ...
    /** Termux app name */
    public static final String TERMUX_APP_NAME = "Termux (agent build)"; // Default: "Termux"
    /** Termux package name */
    public static final String TERMUX_PACKAGE_NAME = "com.termux.agent"; // Default: "com.termux"
